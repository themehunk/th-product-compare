            ...
            <div class="container_">
                <div class="th-mobile-settings">
                    <div class="th-color-output">
                        <span class="bold-heading"><?php esc_html_e('Mobile Settings', 'th-product-compare'); ?></span>

                        <div class="th-color-picker th-input input-block">
                            <label class="th-color-title"><?php esc_html_e('Table Style in Mobile (Pro)', 'th-product-compare'); ?></label>
                            <select disabled data-th-save='tablestyle-in-mobile'>
                                <option value="mobile-flex" <?php selected($tablestyle_in_mobile, 'mobile-flex'); ?>>
                                    <?php esc_html_e('Mobile Responsive', 'th-product-compare'); ?>
                                </option>
                                <option value="desktop" <?php selected($tablestyle_in_mobile, 'desktop'); ?>>
                                    <?php esc_html_e('Desktop Style', 'th-product-compare'); ?>
                                </option>
                            </select>
                        </div>

                        <span class="bold-heading"><?php esc_html_e('Product Remove Icon', 'th-product-compare'); ?></span>
                        <div class="th-compare-radio">
                            ...
                            <label class="th-color-title" for="compare-fields-mobile-remove-icon"><?php esc_html_e('Enable Remove Icon on Mobile (Pro)', 'th-product-compare'); ?></label>
                            <i class="description"><?php esc_html_e('Check to show the remove product icon on mobile view.', 'th-product-compare'); ?></i>
                        </div>

                        <span class="bold-heading"><?php esc_html_e('Mobile Colors', 'th-product-compare'); ?></span>
                        <?php
                        th_apply_color('Background Color', 'background-color', 'mobile-table-bg-color');
                        th_apply_color('Content Color', 'color', 'mobile-content-color');
                        th_apply_color('Heading Color', 'color', 'mobile-heading-color');
                        th_apply_color('Border Color', 'border-color', 'mobile-border-color');
                        th_apply_color('Accent Bar Color', 'background-color', 'mobile-accent-color');
                        ?>

                        <span class="bold-heading"><?php esc_html_e('Add To Cart', 'th-product-compare'); ?></span>
                        <?php
                        th_apply_color('Color', 'color', 'mobile-add-to-cart');
                        th_apply_color('Background Color', 'background-color', 'mobile-add-to-cart');
                        ?>

                        <span class="bold-heading"><?php esc_html_e('Rating', 'th-product-compare'); ?></span>
                        <?php
                        th_apply_color('Rating Color', 'color', 'mobile-rating-color');
                        ?>
                    </div>
                </div>
            </div>
                ...
                <div class="th-mobile-content" data-th-output="mobile-content-color" data-th-save="style" data-th="color">
                    ...
                    <div class="th-mobile-header">
                        <div class="th-mobile-header-left">
                            ...
                            <span class="th-mobile-header-title"><?php esc_html_e('ComparePro', 'th-product-compare'); ?></span>
                        </div>
                    ...
                    <div class="th-mobile-row th-mobile-products-row">
                        ...
                        <div class="th-mobile-cell">
                            <div class="th-mobile-product-card">
                                ...
                                <a href="#" class="th-mobile-product-name"><?php esc_html_e('Product Title One', 'th-product-compare'); ?></a>
                                ...
                                <div class="th-mobile-price"><?php esc_html_e('$90.00', 'th-product-compare'); ?></div>
                                <div class="th-mobile-buy-btn" data-th-output="mobile-add-to-cart" data-th-save="style" data-th="background-color|color">
                                    ...
                                    <?php esc_html_e('Buy', 'th-product-compare'); ?>
                                </div>
                            </div>
                        </div>
                        <!-- Product 2 -->
                        <div class="th-mobile-cell">
                            <div class="th-mobile-product-card">
                                ...
                                <a href="#" class="th-mobile-product-name"><?php esc_html_e('Product Title Two', 'th-product-compare'); ?></a>
                                <div class="th-mobile-rating-inline" data-th-output="mobile-rating-color" data-th-save="style" data-th="color">
                                    <span class="th-mobile-star">&#9733;</span> <span class="th-mobile-rate-num">4.8</span>
                                </div>
                                <div class="th-mobile-reviews">(22)</div>
                                <div class="th-mobile-price"><?php esc_html_e('$75.00', 'th-product-compare'); ?></div>
                                <div class="th-mobile-buy-btn" data-th-output="mobile-add-to-cart" data-th-save="style" data-th="background-color|color">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="21" r="1"></circle><circle cx="19" cy="21" r="1"></circle><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"></path></svg>
                                    <?php esc_html_e('Buy', 'th-product-compare'); ?>
                                </div>
                        ...
                        <div class="th-mobile-cell">
                            <div class="th-mobile-product-card">
                                ...
                                <a href="#" class="th-mobile-product-name"><?php esc_html_e('Product Title Three', 'th-product-compare'); ?></a>
                                <div class="th-mobile-rating-inline" data-th-output="mobile-rating-color" data-th-save="style" data-th="color">
                                    <span class="th-mobile-star">&#9733;</span> <span class="th-mobile-rate-num">4.9</span>
                                </div>
                                <div class="th-mobile-reviews">(9)</div>
                                <div class="th-mobile-price"><?php esc_html_e('$60.00', 'th-product-compare'); ?></div>
                                <div class="th-mobile-buy-btn" data-th-output="mobile-add-to-cart" data-th-save="style" data-th="background-color|color">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="21" r="1"></circle><circle cx="19" cy="21" r="1"></circle><path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12"></path></svg>
                                    <?php esc_html_e('Buy', 'th-product-compare'); ?>
                                </div>
                    ...
                    <div class="th-mobile-section-heading" data-th-output="mobile-heading-color" data-th-save="style" data-th="color">
                        ...
                        <?php esc_html_e('DESCRIPTION', 'th-product-compare'); ?>
                    </div>
                    <div class="th-mobile-row th-mobile-attr-row" data-th-output="mobile-border-color" data-th-save="style" data-th="border-color">
                        <div class="th-mobile-cell">
                            <div class="th-mobile-attr-label"><?php esc_html_e('DESCRIPTION', 'th-product-compare'); ?></div>
                            <div class="th-mobile-attr-value"><?php esc_html_e('This is a simple product.', 'th-product-compare'); ?></div>
                        </div>
                        <div class="th-mobile-cell">
                            <div class="th-mobile-attr-label"><?php esc_html_e('DESCRIPTION', 'th-product-compare'); ?></div>
                            <div class="th-mobile-attr-value"><?php esc_html_e('This is a simple product.', 'th-product-compare'); ?></div>
                    ...
                    <div class="th-mobile-section-heading" data-th-output="mobile-heading-color" data-th-save="style" data-th="color">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>
                        <?php esc_html_e('AVAILABILITY', 'th-product-compare'); ?>
                    </div>
                    <div class="th-mobile-row th-mobile-attr-row" data-th-output="mobile-border-color" data-th-save="style" data-th="border-color">
                        <div class="th-mobile-cell">
                            <div class="th-mobile-attr-label"><?php esc_html_e('AVAILABILITY', 'th-product-compare'); ?></div>
                            <div class="th-mobile-attr-value th-mobile-in-stock"><?php esc_html_e('In Stock', 'th-product-compare'); ?></div>
                        </div>
                        <div class="th-mobile-cell">
                            <div class="th-mobile-attr-label"><?php esc_html_e('AVAILABILITY', 'th-product-compare'); ?></div>
                            <div class="th-mobile-attr-value th-mobile-in-stock"><?php esc_html_e('In Stock', 'th-product-compare'); ?></div>
