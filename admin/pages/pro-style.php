...
$blankImgUrl = TPCP_URL . '/assets/img/blank.png';
...
$blankImage = '<img data-th-output="product-img-bg-color" data-th-save-pro="style" data-th="background-color"  src="' . esc_attr($blankImgUrl) . '">';
...
<div class="style_">
    ...
    <div class="dummy-and-style">
                ...
                <div data-group-tabs="style-nav" data-tab-container="style" class="active">
                    <div class="th-color-output">
                        <span class="bold-heading"><?php esc_html_e('Comapre Bar', 'th-product-compare-pro'); ?></span>
                         <input data-innerdynamic="1"  type="text" placeholder="Compare" value="<?php echo esc_html($th_product_atleast_txt); ?>">
                ...
                <div data-group-tabs="style-nav" data-tab-container="setting">
                    <div class="th-color-output">
                        <div class="th-color-picker th-input input-block">
                            ...
                            <input data-innerdynamic="1" type="text" value="<?php echo esc_attr($th_headingText); ?>">
                             
                            <span class="th-color-title popupcount"><?php esc_html_e('Popup Count Text', 'th-product-compare-pro'); ?></span>
                            <input data-innerdynamic="1"  type="text" value="<?php echo esc_attr($th_countText); ?>">
                        ...
                        <div class="th-color-picker th-input input-block">
                            ...
                            <input  type="number" min="16" max="48" value="<?php echo isset($th_compare_option['img-remove-btn-size']) ? intval($th_compare_option['img-remove-btn-size']) : 18; ?>">
                        </div>
                        <?php
                        // -------------- x --------------
                        ?>
        ...
        <div class="th-compare-popup-dummy th-compare-output-wrap">
            <div class="inner-wrap_ " data-th-output="dummy-border-color" data-th-save-pro='style' data-th='border-color'>
            
               <div class="thpreviewbox" style="padding-top: 82px;">

                <div class="th-compare-output-wrap-inner th-popup-preview" data-th-output="global-background" data-th-save-pro="style" data-th="background-color">
                <div class="preview-top-header"><span></span><span></span><span></span></div>
    <div class="th-compare-heading" data-th-output="heading-style-bg" data-th-save-pro="style" data-th="background-color|color">
        <div class="headingwrap">
            <span class="heading_" data-th-output="heading-style" data-th-save-pro='style' data-th='color'><?php echo esc_html($th_headingText); ?></span>
            <span class="th-compare-count" data-th-output="heading-style" data-th-save-pro='style' data-th='color'><?php esc_html_e('2 Items Shown','th-product-compare-pro'); ?></span>
        </div>
        <span class="error_"></span>
        <div class="th-compare-output-close">
            <i class="dashicons dashicons-no-alt" data-th-output="close-btn-style" data-th-save-pro='style' data-th='background-color|color'></i>
        </div>
        ...
        <div class="th-heighlights-products">
            <div class="th-hide-similarities" data-th-output="heading-style" data-th-save-pro='style' data-th='color'><?php esc_html_e('Hide Similarities','th-product-compare-pro'); ?></div>
            <div class="th-highlight-difference" data-th-output="heading-style" data-th-save-pro='style' data-th='color'><?php esc_html_e('Highlight Differences','th-product-compare-pro'); ?></div>
        </div>
    </div>

    <div class="th-compare-output-product">
        <table class="product-table-configure woocommerce th-desktop-type-displey with-footer-bar" data-th-output="product-img-bg-color" data-th-save-pro="style" data-th="background-color">
            <tbody data-th-output="table-content-color" data-th-save-pro="style" data-th="background-color|color">
                        ...
                        <div class="pc-product-details">
                            <div class="_image_">
                                <div class="image-and-addcart">
                                    <div class="img_">
                                        <button class="th-img-remove-btn" data-th-output="img-remove-icon-color" data-th-save-pro="style" data-th="background-color|color"><i class="dashicons dashicons-no-alt"></i></button>
                                        <a target="_blank" href="#">
                                            <?php echo wp_kses($blankImage, Tpcp_product_compare::$allowKsesAttr);  ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="_add-to-cart_">
                                <div class="th-add-to-cart_" data-th-output="add-to-cart" data-th-save-pro="style" data-th="background-color|color">
                ...
                <tr class="_rating_">
                    ...
                    <td class="thcpr-by-all thcpr-by-accessories">
                        ...
                        <span class="th-compare-rating">
                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5" data-th-output="rating-color" data-th-save-pro='style' data-th='color'>
                                <span></span>
                            </div>
                        </span>
                    </td>
    ...
    <div class="th-compare-footer-level2" data-th-output="footer-bar-bg-color" data-th-save-pro="style" data-th="background-color|color">
        <div class="th-compare-footer-level3">
            ...
            <div class="th-compare-left">
                ...
                <p class="th-atleast">
                    <span class="th-selected" data-th-output="footer-content-color" data-th-save-pro="style" data-th="background-color|color"><?php echo esc_html($first_text); ?></span>
                    <span class="th-select-count" data-th-output="footer-content-color" data-th-save-pro="style" data-th="background-color|color"><?php echo esc_html($second_text); ?> </span>
                </p>
                ...
                <div class="th-addremove" >
                    ...
                    <span class="th-compare-limit-count" data-th-output="footer-content-color" data-th-save-pro="style" data-th="background-color|color"><span class="th-current-count">2</span>/<span class="th-max-count">8</span></span>
                </div>
            </div>
            
            <!-- Right Section -->
            <div class="th-compare-right">
                <a id="thpc-removeall" data-th-output="footer-content-color" data-th-save-pro="style" data-th="background-color|color">
                ...
                <div class="th-compare-enable">
                    <a href="#" class="th-compare-footer-product-opner" data-th-output="footer-bar-btn-color" data-th-save-pro="style" data-th="background-color|color">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" 
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" 
