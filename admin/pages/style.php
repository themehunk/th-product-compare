    ...
    <div class="dummy-and-style">
        <div class="style-setting_">
            ...
            <div class="th-color-output">
                <?php
                echo th_apply_color(__('Fore Ground Color', 'th-product-compare'), 'background-color', 'fore-ground-bg');
        ...
        <div class="th-compare-popup-dummy" data-th-output="fore-ground-bg">
            <div class="inner-wrap_" data-th-output="dummy-border-color">
                <span data-th-output="heading-style" class="heading">Compare Product</span>
                <div class="table_">
                    <table>
