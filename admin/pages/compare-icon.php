        ...
        <div class="container_">
            ...
            <div data-group-tabs="ci-tabs" data-tab-container="ci-style">
                <table class="th-ci-table">
                    ...
                    <tr>
                        <td>
                            <span class="th-color-title"><?php esc_html_e( 'Sidebar Tab Background', 'th-product-compare' ); ?></span>
                            <span class="th-alt-title"><?php esc_html_e( 'Background color of the sidebar tab button.', 'th-product-compare' ); ?></span>
                        </td>
                        <td>
                            <div class="th-color-picker-wrap">
                                <input type="color"
                    ...
                    <tr>
                        <td>
                            <span class="th-color-title"><?php esc_html_e( 'Sidebar Tab Text Color', 'th-product-compare' ); ?></span>
                            <span class="th-alt-title"><?php esc_html_e( 'Text color of the sidebar tab label.', 'th-product-compare' ); ?></span>
                        </td>
                        <td>
                            <div class="th-color-picker-wrap">
                                <input type="color"
